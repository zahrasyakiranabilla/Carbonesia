...
const milestones = [
  {
    ...
    description:
      "Apotek Asasi pertama kali dibuka di Bandung dengan misi melayani kebutuhan kesehatan masyarakat.",
  },
  {
    year: "2017",
    title: "Ekspansi Cabang",
    description:
      "Membuka cabang kedua untuk menjangkau lebih banyak masyarakat yang membutuhkan.",
  },
  {
    year: "2019",
    title: "Layanan Digital",
    description:
      "Meluncurkan layanan konsultasi online dan pengiriman obat untuk kemudahan pelanggan.",
  },
  {
    year: "2021",
    title: "Sertifikasi ISO",
    description:
      "Mendapatkan sertifikasi ISO 9001:2015 untuk sistem manajemen mutu pelayanan farmasi.",
  },
  {
    year: "2024",
    title: "10 Tahun Pengabdian",
    description:
      "Merayakan satu dekade pengabdian dalam melayani kesehatan masyarakat Indonesia.",
  },
]
