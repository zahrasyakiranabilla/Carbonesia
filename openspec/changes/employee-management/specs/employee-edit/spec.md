...
#### Scenario: Admin tidak dapat mengubah rolenya sendiri
- **WHEN** admin edit akunnya sendiri
- **THEN** sistem menyembunyikan field peran (disabled)
- **AND** menampilkan info "Peran tidak dapat diubah"
