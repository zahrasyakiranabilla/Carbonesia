...
- **THEN** sistem menampilkan tabel dengan kolom: Nama, Email, Status, Aksi
...
### Requirement: Filter Berdasarkan Peran (DEPRECATED)

~Sistem SHALL memungkinkan admin menyaring karyawan berdasarkan peran.~

**Note:** Fitur filter peran dihapus karena semua karyawan memiliki peran "employee".
